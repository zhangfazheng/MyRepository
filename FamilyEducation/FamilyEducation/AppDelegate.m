...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CustomTabBarController *mainVC = [[CustomTabBarController alloc] init];
    ...
    //注册cookie失效时的通知
    //[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(loseCookieAction) name:LOSE_EFFICACY_COOKIE object:nil];
    return YES;
}
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"FamilyEducation"];
