...
double const ScalePhotoWidth = 1500;
...
- (void)show
{
    ...
    frame.size.height = self.sender.view.frame.size.height;
    self.frame=frame;
    ...
    if (self.animate) {
        ...
        CGPoint toPoint   = CGPointMake(kViewWidth/2, self.frame.size.height-kBaseViewHeight/2);
