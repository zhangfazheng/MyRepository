...
- (void)loadView{
    ...
    if (!self.tableview) {
        ...
        if (self.automaticallyAdjustsScrollViewInsets) {
            ...
            vFrame.size.height = self.navigationController.navigationBarHidden?vFrame.size.height:vFrame.size.height;
            vFrame.origin.y = -NAVIGATION_BAR_HEIGHT;
        }
        
        if(!self.hidesBottomBarWhenPushed){
            vFrame.size.height = self.tabBarController.tabBar.hidden?vFrame.size.height:vFrame.size.height-TABBAR_HEIGHT;
        }
