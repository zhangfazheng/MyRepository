...
{
    //器材
    HomePageViewController *essence = [[HomePageViewController alloc] initWithStyle:UITableViewStyleGrouped];
    [self addChildViewController:essence imageName:@"tabBar_essence_icon" titleString:@"器材"];
    //器材包
    BaseViewController *new = [[BaseViewController alloc] init];
   [self addChildViewController:new imageName:@"tabBar_new_icon" titleString:@"器材包"];
    
    //查验
    BaseViewController *firend = [[BaseViewController alloc] init];
    //firend.equipmentsManagerStyle = CheckStyle;
   [self addChildViewController:firend imageName:@"tabBar_friendTrends_icon" titleString:@"查验"];
    ...
    [self addChildViewController:me imageName:@"tabBar_me_icon" titleString:@"我"];
